...
{  "PTFE Packing":{
  ...
  {  "Ceramic Fiber Packing":{
   ...
   {" Cotton Fiber Packing":{
    ...
    "Description": "created from a braid of cotton fibre yarns, cotton fibre packing can be impregnated with either yellow grease or graphite to be flexible and easy to use.",
    "Uses": "based on the above characteristics, cotton fibre packing is ideal for a range of uses in a plant, including but not limited to use as standard packing in a variety of applications, as well as in reciprocating valves."
    }},
   {"Ramie Fiber Packing":{

     "Description": "created from a braid of ramie fibres that could either be impregnated with PTFE, lube oil or with a silicon core, ramie fibre packing can be used in a variety of delicate applications as a result of its potential for vibration absorption.",
     "Uses": "based on the above characteristics, ramie fibre packing is ideal for a range of uses in a plant, including but not limited to use as filters or pumps in industries where abrasive media are common."
   }}
  ...
  "Gasket":[
    ...
    {"Ceramic Gasket":{
      ...
      "Description": "created from ceramic fibre paper, our ceramic gasket is affordable, lightweight and confers excellent thermal resistance."
...
,"Uses": "based on the above characteristics, the corrugated metal gasket is ideal for a range of uses in a plant, including but not limited to flanges, and in gas pipes."

    }},
    {
    "PTFE Gasket":{
      
"Description": "created from PTFE resin, our PTFE gasket has one of the best resistance to chemicals on the planet as well as excellent electrical insulation. It could be also combined with glass fibre."
...
,"Uses": "based on the above characteristics, the flat metal gasket is ideal for a range of uses in a plant, including but not limited to hydraulic presses and ammonia fittings."
  ...
  "Sheets":[
    {"Graphite Sheet":{
      ...
      "Description": "Created from the purest natural graphite, our graphite sheet is made without any chemical additives to give you material with unparalleled compressibility and chemical resistance."
   ...
   { "NR Rubber Sheet":{
      "Description": "created from natural rubber with a host of additives, our NR rubber sheet has properties that can be adjusted to meet specific requirements."
    ...
    "Description": "created from silicone, these sheets evince a range of properties including chemical resistance, resistance to wear, and lightweight."
    ...
    "Description": "created from chloro-sulfonated polyethene, our Hypalon rubber sheet showcases tool ozone resistance and phenomenal weather resistance. It could also function as a replacement for neoprene in certain settings."
    ...
    "Description": "These functional rubber sheets range from anti-static rubber sheets to acid-resistant sheets, and as the name implies, can be manufactured to suit a range of requirements."
    ,"Uses": "based on the above characteristics, functional rubber sheets are ideal for a range of uses, including but not limited to situations requiring high temperature and chemical resistance, or situations with the custom requirement."
    
    Compressed Asbestos Rubber Sheet
            
    "Description": "created from asbestos fibres, natural rubber and filler, our compressed asbestos rubber sheet combines the best of rubber and asbestos to suit your needs."
    ,"Uses": "based on the above characteristics, the compressed asbestos rubber sheet is ideal for a range of uses in a plant, including but not limited to seals in high-performance environments, and in areas where cost is a consideration."
    
    Compressed Sheet Asbestos-Free
            
    "Description": "created from a non-asbestos fibre, our compressed asbestos-free sheet contains latex binder and filling material that gives it unique heat and acid resistance properties."
